...
**The cycle:** implement → **verify** (compile / run / open the actual output) → **review** (run the matching review pass — the hard-rule checklists in verification-protocol.md and quality-gates.md) → **fix** what review found, worst first → verify again → **score** against [quality-gates.md](quality-gates.md).
